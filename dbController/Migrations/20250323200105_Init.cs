    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "CostPrice", "Genre", "IsContinuation", "Pages", "Publisher", "SalePrice", "Title", "Year" },
                values: new object[] { 1, "Sample Author", 10f, "Fiction", false, 300, "Sample Publisher", 15f, "Sample Book", 2020 });
